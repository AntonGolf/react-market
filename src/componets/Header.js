...
export const Header = () => {
    const carts = useSelector((state) => state.cart.basket)
            ...
            <div className="header__wrapper">
                ...
                <div className="header_block">
                    ...
                    <div onClick={() => setOrder(!order)} className="header__cart" to="/">
                        ...
                        {carts.length > 0 ? 
                        (<div className="header__cart-cir">{carts.length}</div>)
                        : null    
                    }
                    ...
                    <div className={`header__top ${order === false ? "header__top-hide" : " "}`} > 
                        ...
                        <div className="header__top-order">
                                <div className="header__top-order_cost">
                                    {totalP} Руб.
                                </div>
                                <button onClick={() => onOrder()} className="header__top-order_bt">Оформить заказ</button>
                        </div>
                    </div>
                </div>
